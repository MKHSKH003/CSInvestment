...
import PostMarketUpdate from './post-market-updates.js';
...
export default class MarketUpdates extends Component {
  ...
  render() {
    const {marketUpdates, loading, PostMarketUpdates, deleteMarketUpdate, currentUser, devices} = this.props;
    //const currentUser = {'id':36, 'name':'skhumbuzo','isAdmin':1}
    return (
      <ScrollView>
