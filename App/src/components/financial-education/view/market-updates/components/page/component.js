...
export default Feeds = ({
    ...
    const [commentSectionVisible, toggleCommentSection] = useState(false)
    ...
    const openCommentSection = ({ post, currentUser }) => {
        setCommentProps({
            post: post,
                    ...
                    <View style={styles.nameContainer}>
                        ...
                        {currentUser.IsAdmin == 1 &&
                            <TouchableOpacity onPress={() => currentUser.IsAdmin == 1 && openDeleteModal(post.Id)}>
                                <Image source={{ uri: 'https://img.icons8.com/ios/48/000000/cancel.png' }} style={styles.deleteIcon} />
                            </TouchableOpacity>
                        }
                    </View>
        ...
        return (
            <View style={styles.cardFooter}>
                <View style={styles.socialBarContainer}>
                    ...
                    <View style={styles.socialBarSection}>
                        <TouchableOpacity style={styles.socialBarButton} onPress={() => openCommentSection({ post, currentUser })}>
