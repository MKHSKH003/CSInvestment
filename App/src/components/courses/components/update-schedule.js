...
export default class Users extends Component {
  ...
  updateSchedule(courseSelected, username)
  {
     this.props.updateSchedule(courseSelected.Id, this.state.date, this.state.venue, username)
     this.props.setUpdateScheduleVisible(false)
     sendPushNotifications(this.props.devices, courseSelected.Name+' course schedule has been updated.');
  }
          ...
          <View style={styles.popupOverlay}>
            <View style={styles.popup}>
              ...
              <View style={styles.popupButtons}>
                <TouchableOpacity onPress={() => {this.state.date!="none" || this.state.venue!="none"? this.updateSchedule(courseSelected, username):setUpdateScheduleVisible(false) }} style={styles.btnClose}>
